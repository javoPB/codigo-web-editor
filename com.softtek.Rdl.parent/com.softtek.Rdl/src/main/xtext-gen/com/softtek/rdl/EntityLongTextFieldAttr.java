...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Entity Long Text Field Attr</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.softtek.rdl.EntityLongTextFieldAttr#getGlossary <em>Glossary</em>}</li>
 *   <li>{@link com.softtek.rdl.EntityLongTextFieldAttr#getWidget <em>Widget</em>}</li>
 *   <li>{@link com.softtek.rdl.EntityLongTextFieldAttr#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link com.softtek.rdl.EntityLongTextFieldAttr#getDb_map <em>Db map</em>}</li>
 *   <li>{@link com.softtek.rdl.EntityLongTextFieldAttr#getData_domain <em>Data domain</em>}</li>
 *   <li>{@link com.softtek.rdl.EntityLongTextFieldAttr#getBusiness_rule <em>Business rule</em>}</li>
 * </ul>
 *
 * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr()
 * @model
 * @generated
 */
public interface EntityLongTextFieldAttr extends EObject
{
  /**
   ...
   * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr_Glossary()
  ...
  /**
   * Sets the value of the '{@link com.softtek.rdl.EntityLongTextFieldAttr#getGlossary <em>Glossary</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr_Widget()
   * @model containment="true"
   * @generated
   */
  Widget getWidget();
  ...
  /**
   * Sets the value of the '{@link com.softtek.rdl.EntityLongTextFieldAttr#getWidget <em>Widget</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr_Constraint()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.softtek.rdl.EntityLongTextFieldAttr#getConstraint <em>Constraint</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr_Db_map()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.softtek.rdl.EntityLongTextFieldAttr#getDb_map <em>Db map</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr_Data_domain()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.softtek.rdl.EntityLongTextFieldAttr#getData_domain <em>Data domain</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.softtek.rdl.RdlPackage#getEntityLongTextFieldAttr_Business_rule()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.softtek.rdl.EntityLongTextFieldAttr#getBusiness_rule <em>Business rule</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
