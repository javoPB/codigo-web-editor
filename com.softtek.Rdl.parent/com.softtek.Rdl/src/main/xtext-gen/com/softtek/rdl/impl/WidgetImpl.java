 ...
 * </p>
 * <ul>
 *   <li>{@link com.softtek.rdl.impl.WidgetImpl#getWidget <em>Widget</em>}</li>
 *   <li>{@link com.softtek.rdl.impl.WidgetImpl#getAttrs <em>Attrs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WidgetImpl extends MinimalEObjectImpl.Container implements Widget
{
   ...
   * @ordered
   */
  protected EList<WidgetAttr> attrs;
  ...
  {
    return RdlPackage.Literals.WIDGET;
  }
  ...
  public void setWidget(String newWidget)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RdlPackage.WIDGET__WIDGET, oldWidget, widget));
  }
   ...
   * @generated
   */
  public EList<WidgetAttr> getAttrs()
  {
    if (attrs == null)
    {
      attrs = new EObjectContainmentEList<WidgetAttr>(WidgetAttr.class, this, RdlPackage.WIDGET__ATTRS);
    }
    return attrs;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RdlPackage.WIDGET__WIDGET:
        return getWidget();
      case RdlPackage.WIDGET__ATTRS:
        return getAttrs();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case RdlPackage.WIDGET__ATTRS:
        getAttrs().clear();
        getAttrs().addAll((Collection<? extends WidgetAttr>)newValue);
        return;
    }
